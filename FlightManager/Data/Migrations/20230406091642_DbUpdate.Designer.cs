...
namespace FlightManager.Data.Migrations
{
    ...
    [Migration("20230406091642_DbUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlightManager.Data.Entities.Flight", b =>
                {
                    ...
                    b.Property<string>("UniCodePlane")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FlightManager.Data.User", b =>
                {
            ...
            modelBuilder.Entity("FlightManager.Data.Entities.Reservation", b =>
                {
                    b.HasOne("FlightManager.Data.Entities.Flight", null)
                        .WithMany("Reservations")
                        .HasForeignKey("FlightId");

                    b.HasOne("FlightManager.Data.User", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FlightManager.Data.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
